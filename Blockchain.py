...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Cucei', amount = 1)
...
def connect_node():
    ...
    response = {'message':'Todos los ndoos estan ahora conectados. El EricCoin Blockchain contiene los siguientes nodos:',
